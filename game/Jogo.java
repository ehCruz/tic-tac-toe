...
public class Jogo extends Thread {
	 ...
	 * matrizPosicoes, recebe como parâmetro uma variável do tipo inteiro, caso seja
	 * igual a 1 verifica se o jogador ganhou, caso seja 2 verifica se a maquina
	 * ganhou. Também faz a verificação se é vez da máquina fazer a jogada.
	 * </p>
	 * 
	 * @author eduardo
	 * 
	 ...
	 * <h1>Ganhou</h1>
	 * <p>
	 * É somente chamada quando um dos jogadores ganhou o jogo, se o jogador ganhou
	 * set a sequência dos botões de verde, se a maquina ganhou set a sequência de
	 * botões vermelho. Ao final realiza a chamada do método de verificação final.
	 * </p>
	 * 
	 * @param btn1
	 * @param btn2
	 ...
	 * <p>
	 * É exibido um JOptionPane, dando a opção para o usuário se ele deseja salvar a
	 * pontução ou continuar jogando.
	 * </p>
	 * 
	 * @author eduardo
	 */
	private void verificaAcaoFinal() {
		opcoes = new String[] { "Sim", "Não" };
		int opcao = JOptionPane.showOptionDialog(null, "Deseja salvar a pontuação?", "", JOptionPane.DEFAULT_OPTION,
	 ...
	 * <p>
	 * Salva as informações do jogo atual, como pontuação e número de vitórias, mas
	 * SOMENTE do jogo atual.
	 * </p>
	 * 
	 * @author eduardo
	 */
